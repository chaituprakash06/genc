-- ============================================
-- SUPABASE SQL MIGRATION: CREATE COLLABORATOR TABLES
...
AND table_name IN ('dispute_collaborators', 'collaborator_activities');

-- Check table structure
\d public.dispute_collaborators;
\d public.collaborator_activities;